function [data, response] = flooddepths(c,id,scenario,varargin)
%FLOODDEPTHS JBARisk flood depth  information.
%   [DATA,RESPONSE] = FLOODDEPTHS(C,COUNTRYID) returns flood depth information for a specific
%   country.  COUNTRYID is input as a scalar string or character vector.
%
%   [DATA,RESPONSE] = FLOODDEPTHS(C,COUNTRYID,SCENARIOID) returns country
%   information for a given scenario.
%
%   [DATA,RESPONSE] = FLOODDEPTHS(C,COUNTRYID,SCENARIOID,VARARGIN) returns country
...
%   For example,
%
%   [data,response] = flooddepths(c,"GB")
%
%   returns
%
%   data =
...
%        Completed: 0
%   
%   data = flooddepths(c,"GB","rcp45_2036-2040")
%
%   data =
%   
%     1x5 table
...
urlString = strcat(c.URL,"flooddepths/",id);
